...
export const OUTFIT_COPIED_MESSAGE_ID = MessageRegistry.OUTFIT_COPIED_MESSAGE_ID;

export class OutfitCopiedMessage {
    race: uint32 = 1;
    gender: uint32 = 0;
    skin: uint32 = 0;
    face: uint32 = 0;
    ...
    write(): TSPacketWrite {
        let packet = CreateCustomPacket(OUTFIT_COPIED_MESSAGE_ID, 0);
